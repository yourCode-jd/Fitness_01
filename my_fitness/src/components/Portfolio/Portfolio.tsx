            ...
            <div className='container'>
                <div className='relative flex flex-col lg:flex-row items-center justify-center gap-20'>
                    <motion.div
                        ...
                        <h2 className='main_heading relative left-40 text-6xl!'>Flourish with Optimism, <br></br> Live <em className='animated'> Deliberately</em></h2>
                        <p className='main_paragraph mt-14! pr-18 '>
